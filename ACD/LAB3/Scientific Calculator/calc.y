...
%token ASIN ACOS ATAN SIN SINH COS COSH TAN TANH INC DEC LAND OR  XOR ASSIGN IOR AND  CEIL FLOOR ABS FACTORIAL CROOT BIN_DEC
...
function: SIN OPENBRACKET expr CLOSEBRACKET
	...
	| FACTORIAL OPENBRACKET expr CLOSEBRACKET
		{ $$ = factorial((int)$3);}
	| CROOT OPENBRACKET expr CLOSEBRACKET
		{ $$ = croot((double)$3);}
